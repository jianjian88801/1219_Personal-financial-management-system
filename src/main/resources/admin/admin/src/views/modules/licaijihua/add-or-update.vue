    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="财务分析" prop="caiwufenxi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="财务分析"
                  v-model="ruleForm.caiwufenxi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.caiwufenxi" label="财务分析" prop="caiwufenxi">
                    <span>{{ruleForm.caiwufenxi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="规划方案" prop="guihuafangan">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="规划方案"
                  v-model="ruleForm.guihuafangan" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.guihuafangan" label="规划方案" prop="guihuafangan">
                    <span>{{ruleForm.guihuafangan}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="理财目标" prop="licaimubiao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="理财目标"
                  v-model="ruleForm.licaimubiao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.licaimubiao" label="理财目标" prop="licaimubiao">
                    <span>{{ruleForm.licaimubiao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiangmumingcheng = true;
          ...
          if(o=='caiwufenxi'){
            this.ruleForm.caiwufenxi = obj[o];
	    this.ro.caiwufenxi = true;
            continue;
          }
          if(o=='guihuafangan'){
            this.ruleForm.guihuafangan = obj[o];
	    this.ro.guihuafangan = true;
            continue;
          }
          if(o=='licaimubiao'){
            this.ruleForm.licaimubiao = obj[o];
	    this.ro.licaimubiao = true;
            continue;
          }
          if(o=='beizhu'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `licaijihua/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.licaijihuaCrossAddOrUpdateFlag = false;
                  this.parent.search();
